...
{
public:
    DX11ShaderProgram(DX11ShaderProgram&& rhs);
    ...
    DX11ShaderProgram& operator = (DX11ShaderProgram&& rhs);
...
private:
    DX11ShaderProgram(DX11ShaderProgram const& rhs);
    DX11ShaderProgram& operator = (DX11ShaderProgram const& rhs);
